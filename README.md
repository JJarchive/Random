...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function drawing(event) {
    ...
    document.getElementById("console").innerHTML = "★★ 행운의 숫자 ★★<br/><br/><br/><br/>" + numArray.join(", ") + "<br/><br/><br/><br/><div id=\"rtime\">&gt; 추첨시각 : " + nowLocaleString  + "<br/>" + "&nbsp;&nbsp;[ " + nowString + " ]</div><br/>" + "<form name=\"download\"><input type=\"submit\" id=\"download\" value=\"다운로드\" title=\"누르면 추첨 결과를 텍스트 형식의 파일로 다운로드합니다. (Download)\" /></form>";
